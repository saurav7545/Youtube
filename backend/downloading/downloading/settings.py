"""
Django settings for downloading project.
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-j+3*-+j)yoq@w7$8m_#5t!6e(@(0tv7_rsn23vg19g9!i4wu3w",
)
...
WSGI_APPLICATION = 'downloading.wsgi.application'
